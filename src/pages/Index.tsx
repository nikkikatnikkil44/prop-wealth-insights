...
const Index = () => {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 wealth-gradient rounded-lg flex items-center justify-center">
                <MapPin className="w-5 h-5 text-white" />
              </div>
              <span className="text-xl font-bold text-gray-900">Wealth Map</span>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button className="wealth-gradient text-white hover:opacity-90 transition-opacity">
                Request Demo
              </Button>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-gray-900 leading-tight mb-6">
                Unlock the Power of{" "}
                <span className="text-gradient">Property & Wealth</span>{" "}
                Intelligence
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button size="lg" className="wealth-gradient text-white hover:opacity-90 transition-opacity px-8 py-4 text-lg">
                  Request Demo
            ...
            <div className="relative animate-scale-in">
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden">
                <div className="aspect-[4/3] bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 p-8">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-full h-full bg-white/5 rounded-lg border border-white/20 relative overflow-hidden">
                          ...
                          <div className="absolute bottom-4 right-4 bg-white/90 rounded-lg p-3 text-xs">
                            ...
                            <div className="text-green-600 font-bold">$2.4M</div>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full animate-float opacity-80"></div>
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-gradient-to-br from-green-400 to-teal-500 rounded-full animate-float opacity-60" style={{animationDelay: '2s'}}></div>
            </div>
          </div>
        </div>
      </section>
            ...
            {[
              ...
              <div key={index} className="text-center group">
                <div className="relative mb-6">
                  <div className="w-16 h-16 wealth-gradient rounded-full flex items-center justify-center text-white font-bold text-lg mx-auto group-hover:scale-110 transition-transform duration-300">
                    {step.step}
                  </div>
                  {index < 3 && (
                    <div className="hidden md:block absolute top-8 left-full w-full h-0.5 bg-gradient-to-r from-blue-200 to-purple-200 transform -translate-y-0.5"></div>
                  )}
                </div>
      ...
      {/* CTA Section */}
      <section className="py-20 wealth-gradient">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-50 px-8 py-4 text-lg font-medium">
              Request Demo
              <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© 2024 Wealth Map. All rights reserved.</p>
